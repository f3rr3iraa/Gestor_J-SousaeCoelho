...
window.initFolhaHoras = async function () {
  ...
  const btnGerarCalendarioImprimir = document.getElementById("btnGerarCalendarioImprimir");
  const btnGerarCalendarioPDF      = document.getElementById("btnGerarCalendarioPDF");
